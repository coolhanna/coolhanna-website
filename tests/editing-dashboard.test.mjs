...
test("dashboard navigation exposes editing as a top-level category", () => {
  const nav = read("app/dashboard/DashboardNav.tsx");
  assert.ok(nav.includes('{ label: "편집", href: "/dashboard/editing" }'));
});

test("editing category shows the training target and two patterns", () => {
  const page = read("app/dashboard/editing/page.tsx");
